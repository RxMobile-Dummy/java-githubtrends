package com.radixweb.trendingrepo.data.local.entity;
...
@Entity
public class TrendRepoEntity implements Parcelable {
    ...
    public TrendRepoEntity() {
    }

    protected TrendRepoEntity(Parcel in) {
    ...
    public static final Creator<TrendRepoEntity> CREATOR = new Creator<TrendRepoEntity>() {
        @Override
        public TrendRepoEntity createFromParcel(Parcel source) {
            return new TrendRepoEntity(source);
        }

        @Override
        public TrendRepoEntity[] newArray(int size) {
            return new TrendRepoEntity[size];
        }
    };
